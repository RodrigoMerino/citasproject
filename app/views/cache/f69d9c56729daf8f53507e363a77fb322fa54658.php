                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><?php echo e($patient->user); ?></td>
                                <td><?php echo e($patient->email); ?></td>
                                <td> <?php echo e($patient->time); ?></td>
                                <td><?php echo e($patient->date); ?></td>
                                <td><?php echo e($patient->doctor); ?></td>
<td> 
                                <?php if(!checkIfPrescriptionExists($patient->id_user,$patient->id_doctor)): ?>
                                <button type="button" class="btn btn-success" data-toggle="modal"
                                        data-target="#item-<?php echo e($patient->id); ?>">Escribir preescripción</button>
                                <?php else: ?>
<a href="/prescription/<?php echo e($patient->id_user); ?>/<?php echo e($patient->date); ?>" ><button  class="btn btn-secondary" type="button">Ver preescripción</button> </a>
                                <?php endif; ?>
                                </td>

                                <!-- Modal -->
                                <div class="modal fade" id="item-<?php echo e($patient->id); ?>" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog  modal-lg shadow" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">
                                                    <?php echo e($patient->id_doctor); ?></h5>
                                            ...
                                            <div class="modal-body">
                                                <form action="/doctor/patient-today" method="POST">
                                                    <input type="hidden" name="user_id" value="<?php echo e($patient->id_user); ?>">
                                                    <input type="hidden" name="doctor_id"
                                                        value="<?php echo e($patient->id_doctor); ?>">
...
<?php echo $__env->make('doctor.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\citasProject\App\Views/doctor/patientTable.blade.php ENDPATH**/ ?>
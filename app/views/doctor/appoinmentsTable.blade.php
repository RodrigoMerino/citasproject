    ...
    <div class=" container-fluid">
        <form method="post" action="create-schedule">
            ...
            <div class="card mb-5">
                ...
                <span class="text-danger "><?php if (isset($data['error']['date'][0])) {
                    echo $data['error']['date'][0];
                    } else {
                    echo '';
                    } ?>
                </span>
                <span class="text-danger "><?php if (isset($data['dateUnique'])) {
                    echo $data['dateUnique'];
                    } else {
                    echo '';
                    } ?>
                </span>
            ...
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="Check-all" onclick="
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" checked name="time[]"
                                                    value="6am" id="Check-item1">

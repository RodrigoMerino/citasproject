...
<td> 
                                @if (!checkIfPrescriptionExists($patient->id_user,$patient->id_doctor))
                                <button type="button" class="btn btn-success" data-toggle="modal"
                                        data-target="#item-{{$patient->id}}">Escribir preescripción</button>
                                @else
<a href="/prescription/{{$patient->id_user}}/{{$patient->date}}" ><button  class="btn btn-secondary" type="button">Ver preescripción</button> </a>
                                @endif
                                </td>

                                <!-- Modal -->
                                <div class="modal fade" id="item-{{$patient->id}}" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog  modal-lg shadow" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">
                                                    {{$patient->id_doctor}}</h5>
